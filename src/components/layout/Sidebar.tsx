...
import {
  ...
  FileBarChart, Upload, Users, Settings, TrendingUp,
} from 'lucide-react'
...
const nav = [
  ...
  { to: '/prediccion',              label: 'Predicción IA',icon: TrendingUp },
...
export default function Sidebar() {
  return (
    <aside className="vs-sidebar">
      <div className="px-3 py-4 d-flex align-items-center gap-2 border-bottom"
